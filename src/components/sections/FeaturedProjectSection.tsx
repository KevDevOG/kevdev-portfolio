  ...
  const featuredProjects = [
    {
      ...
      domain: "garagestudios.es",
      github: "https://github.com/KevDevOG/garage-studios",
      image: "/projects/garage-studios-preview.png",
      status: t("real_project"),
      actionText: "DEMO_ONLINE",
      badgeClass: "bg-emerald-100 dark:bg-emerald-950/40 text-emerald-800 dark:text-emerald-400 border-emerald-300 dark:border-emerald-900/60"
    },
    {
      id: "luz-y-lila",
      title: t("proj1_title"),
      longDescription: t("proj1_desc"),
      technologies: ["Next.js", "TypeScript", "Tailwind CSS", "Supabase", "WhatsApp Flow", "Vercel"],
      features: [
        t("proj1_feature_1"),
        t("proj1_feature_2"),
        t("proj1_feature_3"),
      ...
      status: t("real_project"),
      actionText: p("view_project"),
      badgeClass: "bg-blue-100 dark:bg-blue-950/40 text-blue-800 dark:text-blue-400 border-blue-300 dark:border-blue-900/60"
    },
    {
      id: "cfc-las-palmas",
      title: t("proj2_title"),
      longDescription: t("proj2_desc"),
      technologies: ["Next.js", "TypeScript", "Tailwind CSS", "YouTube RSS", "Responsive UI", "Vercel"],
      features: [
        t("proj2_feature_1"),
        t("proj2_feature_2"),
        t("proj2_feature_3"),
    ...
    <section id="proyectos" className="py-6 border-t border-[var(--border-color)]">
      ...
      <div className="space-y-12">
        {featuredProjects.map((project) => (
          <Card key={project.id} className="dashboard-card relative overflow-hidden bg-gradient-to-br from-zinc-50 via-white to-zinc-100/40 dark:from-zinc-950 dark:via-black dark:to-zinc-950/40 p-6 lg:p-8 transition-colors duration-300">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 relative z-10">
              ...
              <motion.div 
                ...
                className="lg:col-span-6 space-y-6 flex flex-col"
              >
                <div className="space-y-2">
                  <div className="flex flex-wrap items-center gap-2 font-mono text-xs">
                    <Badge className={`${project.badgeClass} uppercase tracking-widest px-2 py-0.5 font-bold border`}>
                      {p("status_stable")}
                    </Badge>
                    ...
                    <span className="text-[var(--text-muted)]">{project.domain}</span>
                  </div>
                ...
                {project.features.length > 0 && (
                  <div className="space-y-3 pt-4 border-t border-[var(--border-color)]/60 mt-auto">
              ...
              <motion.div 
                ...
                className="lg:col-span-6 space-y-6 flex flex-col justify-start"
              >
