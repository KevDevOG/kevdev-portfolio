        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 relative z-10">
          ...
          <div className="lg:col-span-6 space-y-6 flex flex-col justify-between">
            <div className="space-y-3">
              ...
              {/* Browser Mockup */}
              <div className="w-full border border-[var(--border-color)] rounded-xl bg-[var(--bg-card)] overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300">
